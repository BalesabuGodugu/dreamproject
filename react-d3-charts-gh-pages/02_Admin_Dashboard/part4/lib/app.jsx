...
var Cards=React.createClass({
    ...
    getData:function(){
        var color=['#53c79f','#64b0cc','#7a6fca',];
        var heading=['Projects','Developers','Achievements'];
        ...
        var cards=color.map(function(d,i){
            ...
            return (
                <div className="col-xs-4 custom_padding margin-below-20" key={i}>
                    <div className="card" style={style}>
                        ...
                        <div className="card_body">
                            {Math.floor((Math.random() * count) + 3)}
                        </div>
                    </div>
                </div>
            );
